...
class RocksDBVariableTest(test.TestCase):
    ...
    def test_basic(self):
        with self.session(use_gpu=False, config=default_config) as sess:
    ...
    #         dim_list = [1, 8, 16, 128]
    #         kv_list = [
    #             [dtypes.int32, dtypes.double], [dtypes.int32, dtypes.float32],
    ...
    #             table = de.get_variable(
    #                 "t1" + str(_id) + '_test_variable_initializer',
    #                 key_dtype=dtypes.int64,
    #                 value_dtype=dtypes.float32,
    #                 initializer=initializer,
    #                 dim=10,
    ...
    #     with self.session(config=config, use_gpu=test_util.is_gpu_available()) as sess:
    #         default_val = -1
    #         keys = constant_op.constant([0, 1, 2], dtypes.int64)
    #         values = constant_op.constant([[0], [1], [2]], dtypes.int32)
    #         table = de.get_variable(
...
if __name__ == "__main__":
    ...
    print(dir(de.python.ops.cuckoo_hashtable_ops.cuckoo_hashtable_ops))
    print(dir(de.python.ops.rocksdb_table_ops.rocksdb_table_ops))
    # test.main()
