...
cuckoo_hashtable_ops = LazySO("dynamic_embedding/core/_cuckoo_hashtable_ops.so").ops
...
class CuckooHashTable(LookupInterface):
    ...
    def export(self, name=None):
        ...
        """
        with ops.name_scope(
            name, "%s_lookup_table_export_values" % self.name, [self.resource_handle]
        ):
            with ops.colocate_with(self.resource_handle):
                (
                    exported_keys,
