...
def sparse_segment_sum(data,
                       ...
                       num_segments=None):
  """
  Computes the sum along sparse segments of a tensor. Only GPU version is
  enabled. If CPU version is needed, please use `tf.sparse.segment_sum`.
  ...
  if gpu_devices:
    if context.executing_eagerly():
      try:
        ...
        tf_logging.warn('Failed use tfra.dynamic_embedding.sparse_segment_sum.'
                        ' Use tf.sparse.segment_sum instead.')
