...
REGISTER_OP(PREFIX_OP_NAME(LookupTableFind))
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableFindWithExists))
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("default_value: Tout")
    .Output("values: Tout")
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableInsert))
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("values: Tout")
    .Attr("Tin: type")
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableAccum))
    .Input("table_handle: resource")
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableRemove))
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Attr("Tin: type")
    .SetShapeFn([](InferenceContext *c) {
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableClear))
    .Input("table_handle: resource")
    .Attr("key_dtype: type")
    .Attr("value_dtype: type");

REGISTER_OP(PREFIX_OP_NAME(LookupTableSize))
    .Input("table_handle: resource")
    .Output("size: int64")
    .SetShapeFn(ScalarAndTwoElementVectorInputsAndScalarOutputs);

REGISTER_OP(PREFIX_OP_NAME(LookupTableExport))
    .Input("table_handle: resource")
    .Output("keys: Tkeys")
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableSaveToFileSystem))
    .Input("table_handle: resource")
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableImport))
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("values: Tout")
    .Attr("Tin: type")
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableLoadFromFileSystem))
    .Input("table_handle: resource")
    .Input("dirpath: string")
    .Input("file_name: string")
    .Attr("key_dtype: type")
...
Status LookupTableShape(InferenceContext *c, const ShapeHandle &key,
...
REGISTER_OP(PREFIX_OP_NAME(LookupTableOfTensors))
    ...
    .SetShapeFn([](InferenceContext *c) {
      ...
      return LookupTableShape(c, /*key=*/c->Scalar(), /*value=*/value_s);
    });
}  // namespace tensorflow