...
# $ docker build -f cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.10.Dockerfile . \
#  --tag "tfra/nosla-cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.10"
# $ docker push tfra/nosla-cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.10
...
RUN /install/build_and_install_python.sh "3.10.9"
