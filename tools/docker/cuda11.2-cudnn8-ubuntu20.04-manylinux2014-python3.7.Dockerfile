...
# $ docker build -f cuda11.2-cudnn8-ubuntu20.04-manylinux2014-python3.7.Dockerfile . \
#  --tag "tfra/nosla-cuda11.2-cudnn8-ubuntu20.04-manylinux2014-python3.7"
# $ docker push tfra/nosla-cuda11.2-cudnn8-ubuntu20.04-manylinux2014-python3.7
