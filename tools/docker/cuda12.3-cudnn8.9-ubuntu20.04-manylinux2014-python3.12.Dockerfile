...
# $ docker build -f cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.12.Dockerfile . \
#  --tag "tfra/nosla-cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.12"
# docker login -u user -p token
# $ docker push tfra/nosla-cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.12
...
RUN /install/build_and_install_python.sh "3.12.5"

COPY install/install_pip_packages_by_version.sh /install/
RUN /install/install_pip_packages_by_version.sh "/usr/local/bin/pip3.12"
