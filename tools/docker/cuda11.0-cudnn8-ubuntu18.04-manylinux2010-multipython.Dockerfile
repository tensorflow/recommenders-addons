...
# $ docker build -f cuda11.0-cudnn8-ubuntu18.04-manylinux2010-multipython.Dockerfile . \
#  --tag "tfra/nosla-cuda11.0-cudnn8-ubuntu18.04-manylinux2010-multipython"
# $ docker push tfra/nosla-cuda11.0-cudnn8-ubuntu18.04-manylinux2010-multipython
