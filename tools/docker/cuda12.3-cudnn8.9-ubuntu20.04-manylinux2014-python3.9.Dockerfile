...
# $ docker build -f cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.9.Dockerfile . \
#  --tag "tfra/nosla-cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.9"
# docker login -u user -p token
# $ docker push tfra/nosla-cuda12.3-cudnn8.9-ubuntu20.04-manylinux2014-python3.9
