...
```shell
python $(pwd)/tensorflow_recommenders_addons/tools/build_api_docs.py
```
"""
...
GITHUB_CODE_PATH = (
    ...
    "blob/main/tensorflow_recommenders_addons/"
)
...
def build_api_docs(output_dir: Text = "/tmp/tensorflow_recommenders_addons/api_docs",
                   code_url_prefix: Text = GITHUB_CODE_PATH,
                   search_hints: bool = True,
                   site_path: Text = "recommenders-addons/api_docs/") -> None:
  """Builds the API docs."""
  ...
  doc_generator = generate_lib.DocGenerator(
      root_title="TensorFlow Recommenders-Addons",
      py_modules=[("tfra", tfra)],
